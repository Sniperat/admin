# Generated by Django 2.1.15 on 2021-06-05 20:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Plant_type_doc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Garden_info')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(max_length=50)),
                ('Plant_type_fact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Garden_info')),
            ],
        ),
        migrations.CreateModel(
            name='Planting_plan',
            fields=[
                ...
                ('Planting_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Garden_info')),
            ],
        ),
        migrations.CreateModel(
            name='Property_info',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Property_photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Property_info')),
            ],
        ),
        migrations.CreateModel(
            name='Room_info',
            fields=[
                ...
                ('Room_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Property_info')),
            ],
        ),
        migrations.CreateModel(
            name='Tex_info',
            fields=[
                ...
                ('Tex_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Property_info')),
            ],
        ),
        migrations.CreateModel(
            name='User_housemate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('User_housemate_tel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.User_housemate')),
            ],
        ),
        migrations.CreateModel(
            name='User_info',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('User_law_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.User_info')),
            ],
        ),
        migrations.CreateModel(
            name='User_tel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_tel', models.CharField(max_length=13)),
                ('User_tel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.User_info')),
            ],
        ),
        migrations.AddField(
